...
int main(int argc, char** argv) {
   ...
   // going faster)
   motionHandler.setAbsMaxVel(180);
   ...
   ArActionStallRecover recover("Stall Recover", 225, 50, 100);
   ArActionBumpers bumpers("Bumpers", 100, 500, 1000);
   ArActionGoto gotoGoal("GO to Target", goal, 100, motionHandler.getAbsMaxVel(), motionHandler.getAbsMaxRotVel());
   ArActionAvoidFront avoidFrontNear("Avoid Front Near", 225, 100, 30);
   ArActionAvoidFront avoidFrontFar;
   ArActionAvoidSide avoidSide("Avoid Side", 300, 30);
